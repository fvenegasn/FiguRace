...
def generar_tarjeta(dataset_actual,cant_caracteristicas):
    ...
    correcta = [sg.Button(nombre_correcta,key="ok",border_width=2,button_color='LavenderBlush3',size=(20,1))]

    opciones = [[sg.Button(x,key="error",border_width=2,button_color='LavenderBlush3',size=(20,1))] for x in nombre_incorrectas]
